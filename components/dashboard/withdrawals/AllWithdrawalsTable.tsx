// /app/withdrawals/_components/AllWithdrawalsTable.tsx
'use client'
...
interface AllWithdrawalsTableProps {
...
export default function AllWithdrawalsTable({ initialWithdrawals, funds }: AllWithdrawalsTableProps) {
