  ...
  return {
    groq: {
      ...
      models: [
        ...
        { id: "qwen/qwen3-32b", label: "Qwen 3 32B", contextWindow: 131072 },
      ],
      headers: {},
    },
    openrouter: {
      ...
      models: [
        { id: "openrouter/free", label: "Auto (Free Models)", contextWindow: 131072 },
      ],
      headers: {
    ...
    huggingface: {
      ...
      models: [
        { id: "meta-llama/Llama-3.2-3B-Instruct", label: "Llama 3.2 3B", contextWindow: 8192 },
      ],
      headers: {},
    },
  };
